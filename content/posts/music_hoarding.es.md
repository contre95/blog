...
Como fuente principal de música uso distintos servicios pero principalmente [Deezer](https://www.deezer.com/), sobre todo porque me permite bajar desde un album completo, hasta canciones individuales. Su mayor bondad es la calidad FLAC, pero no es lo único. Tiene la ventaja, aunque Deezer así no lo considere, de tener un compañero de software libre que permite la descarga de su música y demás metadata. [Deemix](https://dee-mix.one/en/download/), no solo descarga la múica, sino mucha metadata que ayuda con la categorización. Además, como mucho del contenido que existe en Deezer está en Spotify, te permite descargar playlists enteras que existen en Spotify, solamente con el link. Lo q resulta conveniente cuando te comparten música tu amigos normies. 
